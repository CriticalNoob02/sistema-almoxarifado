...
class Sistema(Recebimento, Triagem, Estoque):
    ...
    def cadastroDeFuncionarios(self):
        ...
        acesso = input("Digite o tipo de ACESSO dele: ")
        nome = nome.capitalize().strip()
        acesso = acesso.upper().strip()
